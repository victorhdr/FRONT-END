...
16. [Ejercicio Adicional 4 — Integración de 5 APIs Externas (YouTube, OSM, NASA APOD, Picsum y RandomUser)](#ejercicio-adicional-4--integracion-de-5-apis-externas)

17. [Ampliación de la Práctica 3 — Prototipos Avanzados](#-ampliación-de-la-práctica-3--prototipos-avanzados)  
&nbsp;&nbsp;17.1 [Prototipo 1 — Sistema de Recomendaciones Inteligentes (AJAX + MVP)](#-prototipo-1--sistema-de-recomendaciones-inteligentes-ajax--mvp)  
&nbsp;&nbsp;17.2 [Prototipo 2 — Constructor de Productos Personalizados](#-prototipo-2--constructor-de-productos-personalizados)  
&nbsp;&nbsp;17.3 [Prototipo 3 — Panel de Actividad del Usuario](#-prototipo-3--panel-de-actividad-del-usuario)  

18. [Mejoras Avanzadas No Obligatorias](#-mejoras-avanzadas-no-obligatorias)  
&nbsp;&nbsp;18.1 [Modo Oscuro Glassmorphism Pro](#-modo-oscuro-glassmorphism-pro)  
&nbsp;&nbsp;18.2 [Botón para borrar actividad reciente](#-botón-para-borrar-actividad-reciente)  
&nbsp;&nbsp;18.3 [Generador de actividad de prueba (modo debug)](#-generador-de-actividad-de-prueba-modo-debug)  
&nbsp;&nbsp;18.4 [Gráfica personalizada sin librerías](#-gráfica-personalizada-sin-librerías)  
&nbsp;&nbsp;18.5 [Sistema real de actividad del usuario](#-sistema-real-de-actividad-del-usuario)  
&nbsp;&nbsp;18.6 [Integración del constructor con el carrito](#-integración-del-constructor-con-el-carrito)  
&nbsp;&nbsp;18.7 [Integración del carrito como vista independiente](#-integración-del-carrito-como-vista-independiente)  
&nbsp;&nbsp;18.8 [Eliminación de búsquedas recientes](#-eliminación-de-búsquedas-recientes)  
...
# Ejercicio Adicional 4 — Integración de 5 APIs Externas

Este ejercicio demuestra la integración de **5 APIs externas reales** dentro del proyecto Flask + MVC Frontend.  
Cada API cumple un propósito distinto: multimedia, mapas, datos científicos, imágenes dinámicas y generación de usuarios.

---

# ✅ 1. YouTube IFrame API — Reproductor interactivo

La API oficial de YouTube permite:

- Insertar vídeos sin publicidad intrusiva.
- Controlar el reproductor desde JavaScript (play, pause, stop).
- Crear experiencias personalizadas como reproductores minimalistas.
- Cargar vídeos dinámicamente sin recargar la página.

### ✔ Demostración en el proyecto
Se creó una página dedicada donde:

- Se carga un vídeo mediante `YT.Player()`.
- El usuario puede reproducir, pausar o reiniciar el vídeo.
- El video se incrusta sin abandonar la web.

### ✔ Por qué es relevante
YouTube es la API multimedia más usada; demuestra integración profesional y control DOM–JS.

---

# 🗺️ 2. OpenStreetMap + Leaflet — Mapa interactivo

Leaflet es la librería más utilizada para mapas abiertos.  
Permite:

- Pintar un mapa interactivo.
- Hacer zoom/pan con suavidad.
- Añadir marcadores, popups o coordenadas dinámicas.

### ✔ Lo que incluye tu implementación

- Mapa centrado en Madrid.
- Zoom configurable.
- Marcador inicial visible.
- Carga 100% mediante JS en frontend.

### ✔ Importancia técnica
Integra una API visual compleja, demostrando manejo de recursos externos y eventos.

---

# 🌌 3. NASA APOD (Astronomy Picture of the Day)

Una de las APIs públicas más famosas.

Devuelve cada día:

- Una imagen real del universo.
- Su título.
- Su explicación oficial.
- En ocasiones, vídeos o animaciones científicas.

### ✔ Lo que hace tu implementación
La página:

- Consume `https://api.nasa.gov/planetary/apod?api_key=DEMO_KEY`
- Muestra la imagen astronómica del día.
- Añade título + descripción.
- Maneja errores si no hay foto.

### ✔ Valor técnico
Demuestra uso de APIs JSON puras y procesamiento de datos en frontend.

---

# 📸 4. Picsum Random Photo API — Imágenes aleatorias de alta calidad

Picsum permite obtener imágenes libres y aleatorias para demostraciones de UI.

### ✔ Características

- Sin API Key.
- URLs directas a imágenes tipo `/200/300?random`.
- Muy útil para proyectos visuales.

### ✔ En tu proyecto

- Botón “Cargar foto aleatoria”.
- Imagen centrada en tarjeta adaptable.
- Animación fade-in.
- Manejo de error si la imagen no carga.
- Diseño cuidadoso con bordes, sombras y espaciado.

---

# 👤 5. RandomUser API — Generador de perfiles de usuario

Esta API devuelve un usuario falso realista con:
...
- Tarjeta con nombre, email y país.
- Botón “Generar otro”.
- Animación suave al cargar nuevos datos.

### ✔ Valor técnico
Simula generación realista de usuarios y manipulación avanzada del DOM.

---

# 📌 Justificación global (para entregar en la práctica)

Las cinco APIs se han integrado con:

- **Rutas Flask dedicadas** (`api_youtube`, `api_osm`, `api_nasa`, `api_fotos`, `api_usuario`).
- **JS modular** en `static/js/`.
- **Plantillas propias** en `templates/apis/`.
- **Diseño uniforme** siguiendo el estilo de MiTienda.
- **Experiencia visual e interactiva**, variando entre multimedia, mapas, fotos y datos externos.

Esto demuestra dominio de:

- APIs REST externas
- Integración JSON/JS
- Manipulación avanzada del DOM
- Control de errores
- Esquema MVC Frontend + Flask Backend
...
# 🚀 Ampliación de la Práctica 3 — Prototipos Avanzados

Además de cumplir todos los requisitos obligatorios de la Práctica 3, se han desarrollado **tres prototipos funcionales adicionales**, diseñados para ampliar la experiencia del usuario, demostrar dominio del patrón MVC/MVP y aportar valor técnico real al proyecto.

Estos prototipos no sustituyen funcionalidades existentes, sino que **se integran de forma modular y coherente** dentro de la arquitectura ya implementada.

---

## 🧩 Prototipo 1 — Sistema de Recomendaciones Inteligentes (AJAX + MVP)

### 🎯 Objetivo
Ofrecer recomendaciones dinámicas de productos basadas en:
- Búsquedas del usuario.
- Datos obtenidos desde una API externa real.
- Filtros aplicados sin recargar la página.

### 🏗 Arquitectura utilizada
Se implementa **MVP (Model–View–Presenter)** en JavaScript:

- **RecoModel**
  - Consume la API externa (DummyJSON).
  - Aplica filtros de precio y categoría.
  - Gestiona búsquedas recientes en `localStorage`.

- **RecoView**
  - Renderiza resultados, filtros y chips de búsquedas recientes.
  - No contiene lógica de negocio.
  - Expone métodos para mostrar mensajes y limpiar resultados.

- **RecoController**
  - Orquesta la búsqueda.
  - Ejecuta una única petición AJAX por término.
  - Coordina guardado, filtrado y renderizado.

### 🔄 Flujo AJAX
1. El usuario introduce un término de búsqueda.
2. El controller valida la entrada.
3. El model consulta la API externa con `fetch()`.
4. Los resultados se almacenan en memoria.
5. Los filtros se aplican sin nuevas peticiones.
6. La vista se actualiza dinámicamente.

### 🛠 Problemas y soluciones
- **Evitar peticiones duplicadas** → cacheo de resultados en memoria.
- **Búsquedas vacías** → validación previa y mensaje al usuario.
- **Exceso de estado en la vista** → separación estricta MVP.

---

## 🧩 Prototipo 2 — Constructor de Productos Personalizados

### 🎯 Objetivo
Permitir al usuario crear un producto personalizado y añadirlo directamente al carrito.

### 🏗 Arquitectura
Integrado dentro del MVC frontend existente:

- **Modelo**
  - Construye el objeto producto final.
  - Calcula precio dinámicamente.

- **Vista**
  - Renderiza formulario y resumen visual.
  - Actualiza precio en tiempo real.

- **Controlador**
  - Coordina selección de opciones.
  - Envía el producto final al carrito.

### 🔄 Flujo de datos
1. El usuario selecciona opciones del producto.
2. El precio se recalcula dinámicamente.
3. El producto se serializa en JSON.
4. Se añade como producto real al carrito.

### 🛠 Valor añadido
- Reutiliza el sistema de carrito existente.
- Simula un flujo real de e-commerce avanzado.
- Demuestra extensibilidad del sistema.

---

## 🧩 Prototipo 3 — Panel de Actividad del Usuario

### 🎯 Objetivo
Ofrecer un panel avanzado que muestre la actividad real del usuario en la aplicación.
...
- Gráfica animada sin librerías externas.
- Lista cronológica de eventos.
- Modo debug para generación de actividad de prueba.

### 🏗 Arquitectura
Implementado en **MVP independiente**:

- **UserActivityModel**
  - Unifica actividad real (`localStorage`) + datos de ejemplo.
  - Normaliza eventos.
  - Genera datos para gráficas.

- **UserActivityView**
  - Renderiza tarjetas, gráfica y lista.
  - Gestiona estados de carga y vacío.

- **UserActivityController**
  - Orquesta filtros y renderizados.
  - Mantiene el panel reactivo sin recargar la página.

### 🛠 Valor técnico
- Simula un sistema de auditoría real.
- Refuerza la coherencia del historial de usuario.
- Aporta una visión analítica del comportamiento.

---

------------------------------------------------------------------------

# ✨ Mejoras Avanzadas No Obligatorias

Además de los prototipos, se han implementado **mejoras adicionales no exigidas**, orientadas a usabilidad, diseño y calidad profesional.

---

## A) Modo Oscuro Glassmorphism Pro

- Tema oscuro completo.
- Diseño con transparencia, blur y bordes suaves.
- Inspiración iOS/macOS.
...
## B) Botón para borrar actividad reciente

- Permite limpiar completamente el historial del usuario.
- Eliminación directa en `localStorage`.
- Actualización inmediata del panel sin recargar la página.
- Muy útil para pruebas y privacidad.

---

## C) Generador de actividad de prueba (Debug)

- Botón visible solo en modo debug.
- Genera eventos distribuidos en varios días.
- Facilita la corrección y evaluación.

---

## D) Gráfica personalizada sin librerías

- Implementada con CSS y JavaScript puro.
- Animaciones suaves.
- Tooltips y estilo tipo Apple.
- Sin dependencias externas.

---

## E) Sistema real de registro de actividad
...
- Registro automático de:
  ...
  - favoritos
  - acciones relevantes
- Base común para todo el panel de usuario.

---

## F) Integración completa del constructor con el carrito

- Exportación a JSON.
- Producto personalizado tratado como producto real.
- Compatible con totales y persistencia.

---

## G) Carrito como vista independiente

- Vista dedicada del carrito.
- Eliminación de productos uno a uno.
- Indicador de cantidad en cabecera.
- Mejor experiencia de usuario.

---

## H) Eliminación de búsquedas recientes (Mejora adicional)

- Botón dedicado para borrar el historial.
- Eliminación directa mediante:
  `localStorage.removeItem("recent_searches");`
- Actualización inmediata de:
  - chips de búsqueda
  - resultados visibles
- Coherente con el sistema de actividad del usuario.
- Refuerza privacidad y control.

---

Esta ampliación demuestra una implementación **modular, escalable, profesional y coherente**, alineada con prácticas reales de desarrollo frontend moderno.
