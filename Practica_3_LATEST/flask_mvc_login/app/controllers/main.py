...
@main_bp.route("/api/youtube")
@login_required
def api_youtube():
    return render_template("api_youtube.html")

@main_bp.route("/api/osm")
@login_required
def api_osm():
    return render_template("api_osm.html")

@main_bp.route("/api/nasa")
@login_required
def api_nasa():
    return render_template("api_nasa.html")

@main_bp.route("/api/fotos")
@login_required
def api_fotos():
    return render_template("api_picsum.html")

@main_bp.route("/api/randomuser")
@login_required
def api_randomuser():
    return render_template("api_randomuser.html")

@main_bp.route("/carrito")
def carrito():
    return render_template("carrito.html")

@main_bp.route("/panel_usuario")
def panel_usuario():
